...
%         for i=1:5
%             distance(i)=((solution(1)-sensor_temp(i,1))^2+(solution(2)-sensor_temp(i,2))^2+(solution(3)-sensor_temp(i,3))^2)^0.5;
%         end
...
%         for j=1:4
%             
%             if distance(j+1)==distance(j) || recv_time_temp(j+1)==recv_time_temp(j)
%                 continue;            
%             end
%             new_v(j)=(distance(j+1)-distance(j))/(recv_time_temp(j+1)-recv_time_temp(j));
%             i=i+1;
%             if average_speed == 0
%                 average_speed = new_v(j);
%             else
%                 average_speed = ((average_speed*(i-1))+new_v(j))/i;
%             end
%         end
...
%         v = average_speed;
% 
%         old_solution = [solution(1),solution(2),solution(3)];
%     
...
%     disp(v);
%     
    array = [array;k,solution(1),solution(2),solution(3),error];
